...
public class Team_mates {
    ...
    public Team_mates(int riotId, String memberRole, int memberPhone, String memberMail, int teamId) {
        this.riot_id = riotId;
    ...
    public boolean equals(Object obj) {
        ...
        final Team_mates other = (Team_mates) obj;
